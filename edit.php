...
// Proteksi: Cek apakah ada parameter id di URL
if (!isset($_GET['id'])) {
...
$id     = $_GET['id'];
$produk = $db->getProduk($id); // Menarik data spesifik
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($db->updateProduk($id, $nama, $brand, $kategori, $harga, $stok, $deskripsi)) {
        header("Location: index.php");
        exit();
    } else {
            ...
            <div class="card shadow-sm border rounded-4 bg-white">
                <div class="card-body p-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <p class="text-secondary small">Perbarui informasi data parfum</p>
                    </div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control rounded-3" id="brand" name="brand"
                                   placeholder="Brand"
                                   value="<?= htmlspecialchars($produk['brand'] ?? '') ?>" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <select class="form-select rounded-3" id="kategori" name="kategori" required>
                                        ...
                                        <?php
                                        $list_kategori = ['Pria', 'Wanita', 'Unisex'];
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" class="form-control rounded-3" id="stok" name="stok"
                                           ...
                                           value="<?= htmlspecialchars($produk['stok'] ?? 0) ?>" required>
                        ...
                        <div class="form-floating mb-4">
                            <textarea class="form-control rounded-3" id="deskripsi" name="deskripsi"
                                      placeholder="Deskripsi" style="height:100px;"><?= htmlspecialchars($produk['deskripsi'] ?? '') ?></textarea>
